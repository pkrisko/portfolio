...
const COLORS = ['#0D94FF', '#0CC1E8', '#00FFE7', '#0CE895', '#0DFF5F'];

function setup() {
  createCanvas(WIDTH, HEIGHT + HEIGHT / 2);
...
function PenroseLSystem() {
   ...
   //a reference would be cool, but I couldn't find a good one
    ...
    this.startLength = 1550.0;
    this.theta = TWO_PI / 12.5663706143591729538505735;
